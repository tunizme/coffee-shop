...
const Coffee = () => {
  ...
  useEffect(() => {
    (async () => {
      setLoading(false);
      const resp = await fetch(`https://api.sampleapis.com/coffee/${type}`);
  ...
  return (
    <>
      <main className="container xl:w-9/12 py-20 mx-auto flex gap-14">
        <aside className="w-2/12 md:flex flex-col items-start gap-1 hidden border-r-[1px] border-[#00000099] text-[#00000099]">
          ...
          <span className="cursor-pointer">
            ...
            <ul className="list-disc list-inside">
              <li className="" onClick={() => setType("iced")}>
                Cà phê lạnh
              </li>
              <li onClick={() => setType("hot")}>Cà phê nóng</li>
            </ul>
          </span>
        </aside>
        <section className="md:w-10/12 mx-auto md:p-0 px-4">
          {loading ? <Products data={data} /> : ""}
        </section>
      </main>
    </>
  );
